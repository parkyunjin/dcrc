##################################################################################
# Title: Exp 1 example generating code - Part2                                   #
#                                                                                #
# This code aims to generate graphs used for repetition in                       #
# Exp 1.                                                                         #
# FINAL CODE                                                                     #
##################################################################################
...
for (seed in 123:(143)){
  ...
  graph_ids <- paste0("graph_n", c(1), "_jaccard")
  
  # List of curvature attributes to process
  curvatures <- c("jac_coef", "jac_curv")
